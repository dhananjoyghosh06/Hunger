...
import {SendOtptoUser} from '../controllers/otp-verification.js';
...
import {handlePaymentWebHook} from '../controllers/handlePaymentWebHook.js'
const router = express.Router();    

router.post('/sign-up', handleUserSignUp)
router.post('/otp-verification', handleotpVerification);
router.post('/otp-sender', SendOtptoUser);
