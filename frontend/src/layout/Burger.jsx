...
import img2 from '../assets/burger.avif'
      ...
      <div className="flex flex-col justify-between items-center">
        <div className="w-full items-center justify-center flex bg-gray-100 rounded mt-5 p-10">
          <div className="flex justify-evenly">
            ...
            >
              <img src={img2} className="w-[150px]" />
              <Link className="absolute bottom-4 left-8 px-6 py-1 rounded bg-white">
                ADD
              </Link>
            </Link>
          </div>
        ...
        <div className="w-full items-center justify-center flex bg-gray-100 rounded mt-5 p-10">
          <div className="flex justify-evenly">
            ...
            >
              ...
              <Link className="absolute bottom-5 left-14 px-6 py-1 rounded bg-white">
                ADD
              </Link>
            </Link>
          </div>
        ...
        <div className="w-full items-center justify-center flex bg-gray-100 rounded mt-5 p-10">
          <div className="flex justify-evenly">
            <div className="flex flex-col w-[50%]">
              <div>
                <h1 className="font-bold ">Cruchcy Chicken Burger</h1>
        ...
        <div className="w-full items-center justify-center flex bg-gray-100 rounded mt-5 p-10">
          <div className="flex justify-evenly">
            <div className="flex flex-col w-[50%]">
              <div>
                <h1 className="font-bold ">Spicy Mutton Burger</h1>
        ...
        <div className="w-full items-center justify-center flex bg-gray-100 rounded mt-5 p-10">
          <div className="flex justify-evenly">
            ...
            <Link
              ...
              onClick={handleOnclick}
            >
              <img src={masroomPizza} className="w-[200px] h-[150px]" />
