...
const UserAddress = () => {
    ...
    const handleSubmit = async(event)=>{
        ...
        const uniqueId = localStorage.getItem('mobileNo');
        console.log(uniqueId);
        axios.post('http://localhost:8000/delhivery/addUserAddress', {uniqueId,addressline1, addressline2,city,district,state,country,pincode})
        .then((p)=>{
            console.log(p);
